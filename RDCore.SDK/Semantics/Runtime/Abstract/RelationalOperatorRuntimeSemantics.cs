...
public abstract record class RelationalOperatorRuntimeSemantics : BinaryOperatorRuntimeSemantics
{
    ...
    protected sealed override VBTypedValue? EvaluateExpressionResult(IVBExecutionContext context, VBBinaryOperatorExpression expression, VBType effectiveType, VBTypedValue lhs, VBTypedValue rhs)
    {
