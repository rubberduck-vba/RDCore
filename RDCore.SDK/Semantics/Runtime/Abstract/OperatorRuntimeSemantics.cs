...
where TFlags : struct, Enum
{
    ...
    /// <param name="conversionContext">The <em>semantic context</em> of the conversion operation involved in this evaluation.</param>
    ...
    /// <param name="index">The input index of the operand.</param>
    ...
    /// <summary>
    /// Analyzes the results of the <em>validate operands</em> evaluation step for a given operand.
    /// </summary>
    /// <param name="resolver">A read-only interface over the current execution context.</param>
    /// <param name="builder">A <em>semantic context builder</em> to accumulate flags.</param>
    /// <param name="expression">The operator expression being evaluated.</param>
    /// <param name="frame">The evaluation frame of the operator expression.</param>
    /// <param name="operandIndex">The input index of the operand.</param>
    /// <returns>The constructed semantic context.</returns>
