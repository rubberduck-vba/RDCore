...
namespace RDCore.SDK.Semantics.Runtime.LetCoercion
{
    ...
    /// </summary>
    public sealed record class VBNumericLetCoercionTypeRuntimeSemantics(IVerboseMessageBuilder FormatterService, ILetCoercionRuntimeSemanticsProvider Provider) 
