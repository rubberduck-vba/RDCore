...
public interface ILetCoercionRuntimeSemanticsProvider
{
    ...
    /// <param name="builder">A <em>semantic context builder</em> to accumulate flags.</param>
...
/// <summary>
/// Manages a stack of frames of the specified type.
/// </summary>
/// <typeparam name="TFrame">The specific type of frame in the stack.</typeparam>
public abstract class StackManager<TFrame> where TFrame : IStackFrame, IEquatable<TFrame>
{
    ...
    /// <summary>
    /// Attemps to push a frame onto the stack.
    /// </summary>
    /// <param name="frame">The frame to be pushed.</param>
    /// <remarks>
    /// ⚠️ Any given frame may only appear once in a stack. This does not prevent multiple frames having identical inputs.
    /// </remarks>
    /// <returns><c>true</c> if the frame was pushed, <c>false</c> otherwise.</returns>
    ...
    /// <summary>
    /// Attemps to <em>pop</em> the top (current) frame.
    /// </summary>
    /// <param name="frame">The returned frame, if successful.</param>
    /// <returns><c>true</c> if a frame could be popped, <c>false</c> otherwise.</returns>
    protected virtual bool TryPopFrame(out TFrame frame)
    {
        ...
        if (_frameStack.TryPop(out TFrame? stackFrame) && stackFrame is not null)
        {
