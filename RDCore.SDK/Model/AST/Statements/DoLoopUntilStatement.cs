...
/// </remarks>
public record DoLoopUntilStatement(Uri SemanticId, SourceLocation Location, BoundExpression ConditionExpression, StatementBlock Body)
    : BoundStatement(SemanticId, Location, $"{Tokens.Loop}-{Tokens.Until}", [ConditionExpression]);
