...
public record class VBAttributeExpression(Location Location, BoundExpression NameExpression, BoundExpression ValueExpression) 
...
public record class VBAsTypeExpression(Location Location, string TypeName, string? QualifierName = default, bool AsAutoObject = false)
    : BoundExpression(Location) { }
...
public record class VBTypedDeclarationExpression(Location Location, string IdentifierName, VBAsTypeExpression? AsTypeExpression = default) 
    : BoundExpression(Location) { }
...
public record class VBDeclarationStatement(Location Location, VBTypedDeclarationExpression[] Declarations, AccessModifier? Modifier = AccessModifier.Implicit, bool IsWithEvents = false, bool IsStatic = false) 
