...
/// <summary>
/// Represents a <c>Property Set</c> procedure declaration symbol.
/// </summary>
public sealed record class VBPropertySetMemberSymbol : VBProcedureMemberSymbol, IVBPropertyMemberSymbol
{
    /// <summary>
    /// Creates a new <c>VBPropertySetMemberSymbol</c> that is not linked to a document location.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Creates a new <c>VBPropertySetMemberSymbol</c> that is linked to a document location.
    /// </summary>
    /// <remarks>
