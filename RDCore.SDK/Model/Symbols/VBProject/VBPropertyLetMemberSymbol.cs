...
/// </summary>
public sealed record class VBPropertyLetMemberSymbol : VBProcedureMemberSymbol, IVBPropertyMemberSymbol
{
    /// <summary>
    /// Creates a new <c>VBPropertyLetMemberSymbol</c> that is not linked to a document location.
    /// </summary>
    /// <remarks>
    ...
    public VBPropertyLetMemberSymbol(ScopeKind scope, Uri workspaceRoot, string name, AccessModifier accessibility, Uri parentUri)
        : base(scope, workspaceRoot, SymbolKindExt.Property, name, accessibility, parentUri) { }

    /// <summary>
    /// Creates a new <c>VBPropertyLetMemberSymbol</c> that is linked to a document location.
    /// </summary>
    /// <remarks>
    ...
    public VBPropertyLetMemberSymbol(ScopeKind scope, Uri workspaceRoot, string name, AccessModifier accessibility, Uri parentUri, Range range, Range selectionRange)
