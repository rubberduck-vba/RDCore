...
public sealed record class VBPropertyLetMemberSymbol : VBProcedureMemberSymbol, IVBPropertyMemberSymbol
{
    ...
    public VBPropertyLetMemberSymbol(ScopeKind scope, Uri workspaceRoot, string name, Accessibility accessibility, Uri parentUri)
    ...
    public VBPropertyLetMemberSymbol(ScopeKind scope, Uri workspaceRoot, string name, Accessibility accessibility, Uri parentUri, Range range, Range selectionRange)
