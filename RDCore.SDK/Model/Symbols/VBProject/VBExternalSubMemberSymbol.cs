...
/// <summary>
/// Represents an external <c>Declare Sub</c> member declaration.
/// </summary>
public sealed record class VBExternalSubMemberSymbol : VBProcedureMemberSymbol
{
    /// <summary>
    /// Creates a new <c>VBExternalSubMemberSymbol</c> declaration.
    /// </summary>
    ...
    public VBExternalSubMemberSymbol(ScopeKind scope, Uri workspaceRoot, string name, AccessModifier accessibility, Uri parentUri, Range range, Range selectionRange, bool isPtrSafe, string lib, string? alias)
