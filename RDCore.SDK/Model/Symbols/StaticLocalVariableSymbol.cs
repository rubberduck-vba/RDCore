...
public sealed record StaticLocalVariableSymbol(Uri WorkspaceRoot, Uri ParentUri, string Name, Range Range, Range SelectionRange)
    : LocalVariableSymbol(WorkspaceRoot, ParentUri, Name, ScopeKind.Local, Range, SelectionRange, IsStatic: true){ }
