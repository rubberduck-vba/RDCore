...
public record class LocalVariableSymbol(Uri WorkspaceRoot, Uri ParentUri, string Name, ScopeKind Scope, Range Range, Range SelectionRange, bool IsStatic = false, VBType? ResolvedType = default) 
    : TypedSymbol(WorkspaceRoot, ParentUri, Name, Scope, SymbolKindExt.Variable, Range, SelectionRange, ResolvedType) 
{
    /// <summary>
    ...
    /// </summary>
    public TypedSymbol WithStaticModifier(bool value = true) => this with { IsStatic = value };
}
