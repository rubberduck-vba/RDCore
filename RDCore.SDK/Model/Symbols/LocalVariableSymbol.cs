...
/// <summary>
/// Represents any local variable symbol.
/// </summary>
public record class LocalVariableSymbol : TypedSymbol
{
    /// <summary>
    /// Creates a new <c>LocalVariableSymbol</c> that is linked to a document location.
    /// </summary>
    /// <remarks>
    ...
    public LocalVariableSymbol(ScopeKind scope, Uri workspaceRoot, string name, Uri parentUri, Range range, Range selectionRange) 
        : base(scope, workspaceRoot, name, SymbolKindExt.Variable, Accessibility.Undefined, parentUri, range, selectionRange) { }
}
