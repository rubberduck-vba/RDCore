...
{
    public static readonly StaticSymbol VBVoid = new("(void)", SymbolKindExt.Constant, VBVoidType.TypeInfo);
    public static readonly StaticSymbol TypeDesc = new("Type.Desc", SymbolKindExt.Key, VBTypeDesc.TypeInfo);
    ...
    public static readonly StaticSymbol VBZeroString = new("String.Empty", SymbolKindExt.Constant, VBStringType.TypeInfo);
