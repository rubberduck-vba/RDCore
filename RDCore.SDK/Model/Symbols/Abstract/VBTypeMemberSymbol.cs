...
/// <summary>
/// Represents a symbol that is a member of a parent symbol.
/// </summary>
/// <remarks>
/// All <c>VBTypeMemberSymbol</c> types can be resolved to a <c>VBType</c>; not all <c>VBType</c> are valid MS-VBAL data types.
/// </remarks>
public abstract record class VBTypeMemberSymbol : TypedSymbol
{
    /// <summary>
    ...
    protected VBTypeMemberSymbol(ScopeKind scope, Uri workspaceRoot, string name, SymbolKindExt kind, Accessibility accessibility, Uri parentUri)
    ...
    protected VBTypeMemberSymbol(ScopeKind scope, Uri workspaceRoot, string name, SymbolKindExt kind, Accessibility accessibility, Uri parentUri, Range range, Range selectionRange)
