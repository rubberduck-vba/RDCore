...
/// <summary>
/// The addition (<c>__add_op</c>) binary operator.
/// </summary>
...
/// <summary>
/// The division (<c>__div_op</c>) binary operator.
/// </summary>
...
/// <summary>
/// The exponentiation (<c>__exp_op</c>) binary operator.
/// </summary>
...
/// <summary>
/// The integer division (<c>__idv_op</c>) binary operator.
/// </summary>
...
/// <summary>
/// The modulo (<c>__mod_op</c>) binary operator.
/// </summary>
...
/// <summary>
/// The multiplication (<c>__mul_op</c>) binary operator.
/// </summary>
...
/// <summary>
/// The subtraction (<c>__sub_op</c>) binary operator.
/// </summary>
...
/// <summary>
/// The unary addition (<c>__ad1_op</c>) prefix operator.
/// </summary>
/// <remarks>
...
/// <summary>
/// The unary negation (<c>__ng1_op</c>) prefix operator.
/// </summary>
...
/// <summary>
/// The arithmetic precedence (<c>__p()_op</c>) operator.
/// </summary>
...
/// <summary>
/// The concatenation (<c>__cat_op</c>) binary operator.
/// </summary>
...
/// <summary>
/// The bitwise/logical <c>And</c> (<c>__and_op</c>) operator.
/// </summary>
...
/// <summary>
/// The bitwise/logical <c>Or</c> (<c>___or_op</c>) operator.
/// </summary>
...
/// <summary>
/// The bitwise/logical <c>XOr</c> (<c>__xor_op</c>) operator.
/// </summary>
...
/// <summary>
/// The bitwise/logical <c>Imp</c> (<c>__imp_op</c>) operator.
/// </summary>
...
/// <summary>
/// The bitwise/logical <c>Eqv</c> (<c>__eqv_op</c>) operator.
/// </summary>
...
/// <summary>
/// The value equality (<c>___eq_op</c>) comparison operator.
/// </summary>
...
/// <summary>
/// The value inequality (<c>__neq_op</c>) comparison operator.
/// </summary>
...
/// <summary>
/// The <em>less than</em> (<c>___lt_op</c>) comparison operator.
/// </summary>
...
/// <summary>
/// The <em>greater than</em> (<c>___gt_op</c>) comparison operator.
/// </summary>
...
/// <summary>
/// The <em>less than or equal</em> (<c>__lte_op</c>) comparison operator.
/// </summary>
...
/// <summary>
/// The <em>greater than or equal</em> (<c>__gte_op</c>) comparison operator.
/// </summary>
...
/// <summary>
/// The <c>Like</c> (<c>__lik_op</c>) string comparison operator.
/// </summary>
...
/// <summary>
/// The <c>Is</c> (<c>___is_op</c>) reference equality comparison operator.
/// </summary>
...
#endregion
/// <summary>
/// The <c>.</c> (<c>__bma_op</c>) member access operator.
/// </summary>
