...
namespace RDCore.SDK.Extensibility.Server.Services.States;
...
/// </summary>
public sealed class ServerStateProvider(IOptions<SdkServerOptions> options) : IServerStateProvider, IDisposable
{
