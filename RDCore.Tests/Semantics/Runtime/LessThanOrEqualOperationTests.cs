...
public class LessThanOrEqualOperationTests : SymbolOperationTests
{
    ...
    public void EvaluateLessThanOrEqual_Null_LetCoercion_UDT_TypeMismatch()
    {
        ...
        Assert.Throws<VBRuntimeErrorTypeMismatchException>(() => EvaluateLessThanOrEqual(CreateContext(), lhs, rhs));
    }
    ...
    private VBTypedValue EvaluateLessThanOrEqual(IVBExecutionContext context, object lhs, object rhs)
    {
        ...
        var expression = new VBBinaryOperatorExpression(GlobalSymbols.LessThanOrEqual, lhsExpression, rhsExpression, TestLocation);
