...
{
    internal override IRuntimeSemantics Semantics => new BinaryImpBitwiseOperatorRuntimeSemantics();
    ...
    private VBTypedValue EvaluateImp(IVBExecutionContext context, object? lhs, object? rhs)
    {
        ...
        var expression = new VBBinaryOperatorExpression(GlobalSymbols.OperatorSymbols.BitwiseImp, lhsExpression, rhsExpression, TestLocation);
