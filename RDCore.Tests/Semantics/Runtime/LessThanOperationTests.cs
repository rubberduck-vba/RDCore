...
public class LessThanOperationTests : SymbolOperationTests
{
    ...
    public void EvaluateLessThan_Null_LetCoercion_UDT_TypeMismatch()
    {
        ...
        Assert.Throws<VBRuntimeErrorTypeMismatchException>(() => EvaluateLessThan(CreateContext(), lhs, rhs));
    }
    ...
    private VBTypedValue EvaluateLessThan(IVBExecutionContext context, object lhs, object rhs)
    {
        ...
        var expression = new VBBinaryOperatorExpression(GlobalSymbols.LessThan, lhsExpression, rhsExpression, TestLocation);
