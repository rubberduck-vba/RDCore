...
public class ConcatOperationTests : SymbolOperationTests
{
    ...
    public void EvaluateConcat_ImplicitNumericCoercionDiagnostics(object lhs, object rhs, bool expectDiagnostics)
    {
    ...
    private VBTypedValue EvaluateConcat(VBExecutionContext context, object lhs, object rhs)
    {
        ...
        return SymbolOperation.EvaluateBinaryConcat(context, expression, lhsValue.ResultValue, rhsValue.ResultValue);
    }
}
